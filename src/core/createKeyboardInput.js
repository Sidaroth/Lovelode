...
const createKeyboardInput = function createKeyboardInputFunc() {
    ...
    function keyDownFn(e) {
        ...
        state.emit(eventConfig.KEYBOARD.KEYDOWN, { key: e.key, repeat: e.repeat, keyCode: e.keyCode });
    }

    function keyUpFn(e) {
        keyMap.set(e.keyCode, { repeat: false, down: false });
        state.emit(eventConfig.KEYBOARD.KEYUP, { key: e.key, repeat: e.repeat, keyCode: e.keyCode });
    }
